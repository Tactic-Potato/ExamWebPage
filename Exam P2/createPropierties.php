<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($title && $price && $description && $rooms && $wc && $garage && $timestamp && $seller) {
            $sql = "INSERT INTO property (title, price, image, description, rooms, wc, garage, timestamp, id_seller) VALUES ('$title', $price, '$image', '$description', $rooms, $wc, $garage, '$timestamp', $seller)";
